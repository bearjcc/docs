---
title: "Autex Knowledge Base — Onboarding, Policies, and IT Help"
description: "Your central reference for onboarding, HR policies, IT help, and department runbooks. Everything you need to work confidently at Autex."
mode: custom
---
...
<div className="mx-auto flex w-full max-w-[720px] flex-col gap-12 px-4 py-10 lg:gap-14 lg:py-16">
  <div className="flex flex-col items-center gap-6">
    <div className="flex max-w-[480px] flex-col gap-2 text-center">
      ...
      <p className="text-balance text-base text-gray-600 dark:text-gray-400">
        This is your go-to reference for how things work at Autex. Use the tabs above to navigate to different sections, or press <kbd>⌘</kbd> <kbd>K</kbd> to search.
      </p>
    </div>
  </div>
    ...
    >
      ...
      <div className="flex flex-col gap-1 pt-4">
        ...
        <span className="text-sm leading-5 text-gray-600 dark:text-gray-400">
          Accounts to activate, tools to install, and the people to meet before end of day one.
        </span>
      </div>
    </a>
  ...
  <div className="flex flex-col gap-4">
    ...
    <Columns cols={2}>
      <Card title="HR & People" icon="users" iconType="light" href="/hr-people/index">
        Benefits, time off, performance reviews, and compensation.
      </Card>
      <Card title="IT & Security" icon="shield-check" iconType="light" href="/it-security/index">
        Access requests, device policy, and security training.
      </Card>
    </Columns>

    <Columns cols={2}>
      <Card title="Policies" icon="scroll" iconType="light" href="/policies/index">
        Code of conduct, expense reimbursement, travel, and remote work.
      </Card>
      <Card title="Engineering" icon="code-xml" iconType="light" href="/engineering/index">
